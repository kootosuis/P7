      ...
      <div class="formDiv">
        <form class="formulaire" method="POST" name="form" id="form" @submit="signUp">
          ...
          <div class="formLine">
            ...
            <input class="input" @input="checkForm" type="text" placeholder="Entrez votre nom." id="UserName"
          ...
          <div class="formLine">
            ...
            <input class="input" @input="checkForm" type="text" placeholder="Entrez votre prénom." id="UserFirstname"
          ...
          <div class="formLine">
            ...
            <input class="input" @input="checkForm" type="email" placeholder="Entrez une adresse mail valide."
          ...
          <div class="formLine">
            ...
            <textarea class="smalltextarea input" type="textarea"
              placeholder="Si vous le souhaitez, vous pouvez vous présenter..." id="UserPresentation"
              name="UserPresentation"></textarea>
          </div>
          ...
          <div class="formLine">
            ...
            <textarea class="smalltextarea input" type="textarea" placeholder="Quel est votre rôle dans l'entreprise ?"
              id="UserRole" name="UserRole"></textarea>
          </div>
        ...
        <div id="no-account" class="add-div">
          <p> Déjà un compte ? <router-link class="no-account-link" to="../login">S'authentifier</router-link>
          </p>
        </div>
      </div>
    </div>
